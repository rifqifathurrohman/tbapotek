...
{ 
    ...
    public function __construct()
    {
        ...
        $this->methods['apotek_get']['limit'] = 5000;
        $this->methods['apotek_post']['limit'] = 1000;
    }
    ...
    function apotek_post()
    {
        ...
        if ($data['id_obat'] == NULL || $data['id_golongan'] == NULL || $data['nama_obat'] == NULL || $data['stok'] == NULL || $data['harga'] == NULL) {
            $this->response(
                [
                    'status' => false,
